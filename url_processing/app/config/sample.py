...
# import json
start = time.time()
dictToSend = {'url':'http://www.corelangs.com/html/tables/colspan-rowspan.html','pdf_upload': 'http://10.4.24.5:8003/pdfupload', 'pdf_parser': 'http://10.4.24.5:8003/pdftotxt'}
...
#no dictToSend = {'url':'https://www.nasdaq.com/articles/topics-framing-the-asset-management-industry-in-2019-and-beyond-2020-01-10','pdf_upload': 'http://10.4.24.5:8003/pdfupload', 'pdf_parser': 'http://10.4.24.5:8003/pdftotxt'}
...
# dictToSend = {'url':'https://www.quora.com/What-is-meant-by-wealth-in-economics','pdf_upload': 'http://10.4.24.5:8003/pdfupload', 'pdf_parser': 'http://10.4.24.5:8003/pdftotxt'}
